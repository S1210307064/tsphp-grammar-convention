...
import ch.tsphp.grammarconvention.checks.TokensSpaceCheck;
...
public class TokensSpaceCheckTest extends AGrammarWalkerTest
{
    ...
    protected TokensSpaceCheck createCheck() {
        return new TokensSpaceCheck();
    }
